...
import GoMapsAutocomplete from "./gomaps";
    ...
    <div className="mt-10">
      <div className="text text-center md:text-left">
        ...
        <p className="text-sm text-gray-600 font-medium mt-3">
          ...
          Journeasy will generate a tailored itinerary based on your
          preferences.
        </p>
      </div>
      ...
      <div className="form mt-10 flex flex-col gap-10 md:gap-20 ">
        <div className="place">
          ...
          /> */}
          <GoMapsAutocomplete
            apiKey={import.meta.env.VITE_GO_MAPS_API_KEY}
            onChange={(place) =>
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              <img src="/logo.png" className="w-20 h-20" alt="Google" />
              <span className="flex gap-2">
                <span>
                  {user
                    ? "Logged In Securely to Journeasy with Google Authentication"
                    : "Sign In to Journeasy with Google Authentication Securely"}
                </span>
              </span>
              {user ? (
                ""
